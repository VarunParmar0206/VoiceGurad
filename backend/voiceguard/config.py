...
class Settings(BaseSettings):
    ...
    # Deepfake detector ML model (architecture §11.2)
    DEEPFAKE_DETECTION_THRESHOLD: float = 0.50
    DEEPFAKE_DETECTOR_N_MELS: int = 80
    DEEPFAKE_DETECTOR_CNN_CHANNELS: str = "32,64,128"
    DEEPFAKE_DETECTOR_DROPOUT: float = 0.3
    # Heuristic weights (architecture §11.2 Tier 1)
    DEEPFAKE_HEURISTIC_BOUNDARY_WEIGHT: float = 0.25
    DEEPFAKE_HEURISTIC_PERIODICITY_WEIGHT: float = 0.20
